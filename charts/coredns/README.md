...
| `deployment.enabled`                           | Optionally enable/disable the workload as Deployment and its respective resources.                                                        | `false`                                                      |
...
| `daemonset.enabled`                            | Optionally enable/disable the workload as DaemonSet and its respective resources.                                                         | `true`                                                       |
